...
import hust.soict.hedspi.aims.screen.customer.controller.ViewStoreController; // Đảm bảo import này chính xác cho project của bạn
...
import java.net.URL; // Import thêm URL để kiểm tra
...
public class TestViewStoreScreen extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        System.out.println("Trying to load FXML from: " + location);
    ...
    public static void main(String[] args) {
        ...
        CompactDisc cd1 = new CompactDisc(4, "Thriller", "Pop", 9.99f, 0, "Quincy Jones", "Michael Jackson");
        ...
        CompactDisc cd2 = new CompactDisc(5, "The Dark Side of the Moon", "Progressive Rock", 12.50f, 0, "Pink Floyd (Producer)", "Pink Floyd");
        ...
        CompactDisc cd3 = new CompactDisc(11, "Abbey Road", "Rock", 11.20f, 0, "George Martin", "The Beatles");
